# Attention-Residuals Archify Architecture
...
- Repository URL: https://github.com/hundong2/Attention-Residuals.git
- Checkout SHA: 995b62500b492d8c01b8a411cb80bcab0018f8b1
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: Attention Residuals (AttnRes)
- Dependency markers:
- Top-level directories: assets, docs, guide
- Category: Explainability and study

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for Attention-Residuals.
